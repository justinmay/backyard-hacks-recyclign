...
r = requests.get('https://www.wwf.org.au/news/blogs/17-cool-products-made-from-recycled-plastics#gs.73retz')

soup = BeautifulSoup(r.text, features="html.parser")

###   Finding the names ### ok
product_names = soup.find_all("span", class_="h4 tabindex")
names = []
for product in product_names:
    names.append(product.text)

###   Finding the descriptions ###
product_descriptions = soup.find_all("", class_="gallery-slide-caption__dek")
descriptions = []
